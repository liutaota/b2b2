...
@TableName("PUB_EMPLOYEE")
@ApiModel(value="PubEmployee对象", description="")
@KeySequence(value = "PUB_EMPLOYEE_SEQ")
public class PubEmployee extends Model<PubEmployee> {
    ...
    @TableField("ZX_ATYPE")
    private Double zxAtype;

    @TableField("ZX_CTYPE")
    private Double zxCtype;

    @TableField("ZX_DTYPE")
    private Double zxDtype;
