...
@ApiModel(value = "销售发货单返回实体")
@Data
public class BmsSaDocVo implements Serializable {
    ...
    //销售细单列表
    private List<BmsSaDtlVo> selectBmsSaDtlVos;

    //运货地点列表
    private List<BmsTrPosDefVo> selectBmsTrPosDefVos;
