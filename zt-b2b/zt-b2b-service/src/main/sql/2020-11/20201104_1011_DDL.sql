...
alter table ACTIVITY modify START_EFFECTIVE_TIME VARCHAR2(1024)
/

alter table ACTIVITY modify END_EFFECTIVE_TIME VARCHAR2(1024)
/
...
alter table ORDER_INFO modify ORDER_NO VARCHAR2(1024)
/

alter table ORDER_INFO modify ORDER_TYPE VARCHAR2(1024)
/

alter table ORDER_INFO modify PAY_METHOD VARCHAR2(1024)
/

alter table ORDER_INFO modify PAY_FLOW_NO VARCHAR2(1024)
/

alter table ORDER_INFO modify REFUND_FLOW_NO VARCHAR2(1024)
/

alter table ORDER_INFO modify LOGISTICS VARCHAR2(1024)
/

alter table ORDER_INFO modify ADDRESS_DETAIL VARCHAR2(1024)
/

alter table ORDER_INFO modify REMARK VARCHAR2(1024)
/

alter table ORDER_INFO modify RETURN_LOGISTICS VARCHAR2(1024)
/

alter table ORDER_INFO modify MEMBER_NAME VARCHAR2(1024)
/

alter table ORDER_INFO modify MEMBER_EMAIL VARCHAR2(1024)
/

alter table ORDER_INFO modify MEMBER_PHONE VARCHAR2(1024)
/

alter table ORDER_INFO modify EVALUATION_STATE VARCHAR2(1024)
/

alter table ORDER_INFO modify EVALUATION_AGAIN_STATE VARCHAR2(1024)
/

alter table ORDER_INFO modify ORDER_STATE VARCHAR2(1024)
/

alter table ORDER_INFO modify REFUND_STATE VARCHAR2(1024)
/

alter table ORDER_INFO modify LOCK_STATE VARCHAR2(1024)
/

alter table ORDER_INFO modify INV_TYPE VARCHAR2(1024)
/

alter table ORDER_INFO modify INV_DEMAND VARCHAR2(1024)
/

alter table ORDER_INFO modify TRANSLINENAME VARCHAR2(1024)
/

alter table ORDER_INFO modify EXP_STATUS VARCHAR2(1024)
/

alter table ORDER_INFO modify COUPON_IDS VARCHAR2(1024)
/
