...
@Component
@Lazy
public class UserTokenGranter extends ZSYCTokenGranter {
    private final static String GRANT_TYPE = "user_token";
    ...
    public OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Authentication authenticate = authenticationManager.authenticate(new UserAuthenticationToken(
