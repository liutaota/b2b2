...
@Component
@Lazy
public class TelephoneTokenGranter extends ZSYCTokenGranter {
	private final static String GRANT_TYPE = "telephone_token";

	@Autowired
	private AuthenticationManager authenticationManager;

	public TelephoneTokenGranter() {
		super(GRANT_TYPE);
	}
	...
	public OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		Authentication authenticate = authenticationManager.authenticate(
				new TelephoneAuthenticationToken(
