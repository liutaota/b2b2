...
@Component
@Slf4j
public class WechatAuthenticationProvider extends ZSYCAuthenticationProvider<WechatAuthenticationToken> {
	...
	public UserDetails subAuthenticate(WechatAuthenticationToken authentication) throws AuthenticationException {
		Member member = this.loginService.wechatAuth(authentication.getCode(),authentication.getScanCode());
