...
@Component
@Slf4j
public class TelephoneAuthenticationProvider extends ZSYCAuthenticationProvider<TelephoneAuthenticationToken> {
	...
	@Override
	public UserDetails subAuthenticate(TelephoneAuthenticationToken authentication) throws AuthenticationException {
		Member member = this.loginService.telephoneAuth(authentication.getTelephone(), authentication.getCode(),authentication.getLoginCode(),authentication.getPassword());
