...
@Component
@Lazy
public class MemberIdTokenGranter extends ZSYCTokenGranter {
	private final static String GRANT_TYPE = "memberid_token";


	@Autowired
	private AuthenticationManager authenticationManager;

	public MemberIdTokenGranter() {
		super(GRANT_TYPE);
	}
	...
	public OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		Authentication authenticate = authenticationManager.authenticate(new MemberIdAuthenticationToken(
				Long.valueOf(params.get("memberId"))
		));
