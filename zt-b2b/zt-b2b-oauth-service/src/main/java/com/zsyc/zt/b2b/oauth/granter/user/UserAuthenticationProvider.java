...
@Component
@Slf4j
public class UserAuthenticationProvider extends ZSYCAuthenticationProvider<UserAuthenticationToken> {
    ...
    @Override
    public UserDetails subAuthenticate(UserAuthenticationToken authentication) throws AuthenticationException {
        User user = new User();
