package com.zsyc.zt.order.util;
...
public class AssertExt {
	...
	public static <T> void hasConstant(T[] constants, T constant, String message, Object... args) {
		isTrue(ArrayUtil.contains(constants, constant), message, args);
	}
	...
	public static void isTrue(boolean expression, String message, Object... args) {
		if (!expression) {
			throw new IncaApiRuntimeException(String.format(message, args));
		}
	}
	...
	public static void notEmpty(Object[] array, String message, Object... args) {
		isTrue(!ArrayUtil.isEmpty(array), message, args);
	}
	...
	public static void notBlank(String str, String message, Object... args) {
		isTrue(!ObjectUtil.isEmpty(str), message, args);
	}
